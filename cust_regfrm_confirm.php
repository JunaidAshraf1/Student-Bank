...
<div class="cnfrm_info">
	 ...
	 <span><?php echo "AADHAR No : ".$_SESSION['cust_aadhar']."<br>"; ?> </span>
...
if(isset($_POST['cnfrm-submit'])){ 
	...
	$sender = 'SBIBNK';
	$message = 'Hello '.$name.' your application number for new account opening is '.$application_no.'. Please visit nearest branch to complete your account opening process. Thanks for choosing Student Bank of India. Happy Banking.';
